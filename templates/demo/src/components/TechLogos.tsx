      ...
      {tech.map((item, index) => (
        ...
        >
          ...
          >
            ...
            >
              <CardContent className="flex flex-col items-center justify-center p-6 pt-6 pb-2">
                <div className="max-h-16 max-w-[140px] h-16 w-16 mb-2">
                  {item.logo}
                </div>
              </CardContent>
